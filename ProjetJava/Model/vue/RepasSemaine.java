...
public class RepasSemaine extends JFrame {
	...
	public RepasSemaine(JFrame menuMenu) {
		...
		lblNewLabel_6_2_3.setBounds(47, 204, 99, 14);
		...
		lblNewLabel_6_2_4.setBounds(172, 204, 63, 14);
		...
		JLabel lblNewLabel_6_2_6 = new JLabel("Boulette viande ");
		...
		JLabel lblNewLabel_6_2_12 = new JLabel("Donuts ");
		...
		lblNewLabel_6_2_4_1.setBounds(172, 241, 63, 14);
		...
		lblNewLabel_6_2_5_1.setBounds(292, 241, 107, 14);
		...
		lblNewLabel_6_2_5_1_1.setBounds(539, 241, 126, 14);
		contentPane.add(lblNewLabel_6_2_5_1_1);
		
		JLabel lblNewLabel_6_2_3_1 = new JLabel("ou p\u00E2tes arrabiata");
		lblNewLabel_6_2_3_1.setVerticalAlignment(SwingConstants.TOP);
		lblNewLabel_6_2_3_1.setFont(new Font("Garamond", Font.PLAIN, 12));
		lblNewLabel_6_2_3_1.setBounds(47, 228, 99, 14);
		contentPane.add(lblNewLabel_6_2_3_1);
		
		JLabel lblNewLabel_6_2_3_2 = new JLabel("ou v\u00E9g\u00E9tal");
		lblNewLabel_6_2_3_2.setVerticalAlignment(SwingConstants.TOP);
		lblNewLabel_6_2_3_2.setFont(new Font("Garamond", Font.PLAIN, 12));
		lblNewLabel_6_2_3_2.setBounds(172, 222, 69, 14);
		contentPane.add(lblNewLabel_6_2_3_2);
		
		JLabel lblNewLabel_6_2_3_3 = new JLabel("ou tarte fromage");
		lblNewLabel_6_2_3_3.setVerticalAlignment(SwingConstants.TOP);
		lblNewLabel_6_2_3_3.setFont(new Font("Garamond", Font.PLAIN, 12));
		lblNewLabel_6_2_3_3.setBounds(292, 222, 107, 14);
		contentPane.add(lblNewLabel_6_2_3_3);
		
		JLabel lblNewLabel_6_2_6_1 = new JLabel("ou boulette v\u00E9g\u00E9");
		lblNewLabel_6_2_6_1.setVerticalAlignment(SwingConstants.TOP);
		lblNewLabel_6_2_6_1.setFont(new Font("Garamond", Font.PLAIN, 12));
		lblNewLabel_6_2_6_1.setBounds(414, 222, 89, 14);
		contentPane.add(lblNewLabel_6_2_6_1);
		
		JLabel lblNewLabel_6_2_6_2 = new JLabel("et p\u00E2tes");
		lblNewLabel_6_2_6_2.setVerticalAlignment(SwingConstants.TOP);
		lblNewLabel_6_2_6_2.setFont(new Font("Garamond", Font.PLAIN, 12));
		lblNewLabel_6_2_6_2.setBounds(414, 241, 89, 14);
		contentPane.add(lblNewLabel_6_2_6_2);
		
		JLabel lblNewLabel_6_2_6_3 = new JLabel("ou galette pomme de terre");
		lblNewLabel_6_2_6_3.setVerticalAlignment(SwingConstants.TOP);
		lblNewLabel_6_2_6_3.setFont(new Font("Garamond", Font.PLAIN, 12));
		lblNewLabel_6_2_6_3.setBounds(539, 222, 126, 14);
		contentPane.add(lblNewLabel_6_2_6_3);
