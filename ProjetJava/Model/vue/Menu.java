...
public class Menu extends JFrame {
	...
	public Menu(int level, JFrame menuCo) {
		...
		btnMenu.setBounds(45,67,169,36);
		...
		if(level!=1) {
			JButton btnReserver = new JButton("Réserver un repas");
			btnReserver.setFont(new Font("Tahoma", Font.PLAIN, 14));
			...
			if(level==3 ||level==4) {
				JButton btnListeEleve = new JButton("Liste élèves");
				btnListeEleve.setFont(new Font("Tahoma", Font.PLAIN, 14));
				btnListeEleve.setBounds(450,73,150,25);
				...
				if(level==3) {
					...
					btnEDT.setFont(new Font("Tahoma", Font.PLAIN, 14));
				...
				if(level==4) {
					JButton btnGerer = new JButton("Gérer employés");
					btnGerer.setFont(new Font("Tahoma", Font.PLAIN, 14));
